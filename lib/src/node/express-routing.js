...
exports.getUrlPathBeforeLang = query_1.getUrlPathBeforeLang;
exports.getUrlPathAfterLang = query_1.getUrlPathAfterLang;
...
exports.getFirstUrlPath = function (urlOrReq) {
    if (typeof urlOrReq === 'string')
        return array_1.first(urlOrReq.split('/'));
    return array_1.first(urlOrReq.originalUrl.split('/'));
};
/**
 ...
 * @param {Request} req - Express request object.
 */
exports.getCodeAssetUrl = function (req) { return "/" + array_1.last(req.baseUrl.split('/')); };
/**
