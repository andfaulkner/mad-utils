 ...
 */
exports.uuidRegex = /^[0-9A-F]{8}-[0-9A-F]{4}-[4][0-9A-F]{3}-[89AB][0-9A-F]{3}-[0-9A-F]{12}$/gi;
/**
 * Return true if given value is a UUID (v4)
 */
exports.isUUID = function (value) {
    return typeof value === "string" ? !!value.match(exports.uuidRegex) : false;
};
/********************************************* RANGE **********************************************/
/**
