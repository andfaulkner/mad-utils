...
var hrefDef = window.location.href || '';
...
function getLangFromUrlPathname(urlPath, supportedLangs, defaultLang) {
    ...
    var getLangMatch = function (lang) { return !!urlPath.match(new RegExp("/(" + lang + "[^a-zA-Z0-9])|(/" + lang + "$)", 'g')); };
...
;
exports.postLangUrlPaths = getUrlPathAroundLang;
/**
