 ...
 */
exports.repeatChars = function (repChar, len) { return array_1.arrayN(len, repChar).join(''); };
...
var isRegexString = function (str) {
    return (str instanceof RegExp) || !!str.match(/^\/.+\/[yumig]{0,5}$/);
};
/**
 ...
 */
var getFlagsFromRegexString = function (str) {
 ...
 */
var removeSurroundingRegexSlashes = function (str) {
