...
exports.toSnakeCase = function (str) {
    return !str
        ...
        : str
            ...
            .replace(/([^A-Z])([A-Z]{2,})$/g, function (str, m1, m2) {
            return str.replace(m2, "_" + m2.toLowerCase());
        })
            ...
            .replace(/[^A-Za-z]([A-Z]+)[^A-Za-z]/g, function (str, m1) {
            return str.replace(m1, m1.toLowerCase());
        })
            /*******************************************************************/
