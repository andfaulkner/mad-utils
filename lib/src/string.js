...
exports.toSnakeCase = function (str) {
    ...
    return !str
        ...
        : str
            ...
            .replace(/([^A-Z\u00C0-\u00CF\u00D0-\u00D6\u00D8-\u00DDȘŌŤ])([A-Z\u00C0-\u00CF\u00D0-\u00D6\u00D8-\u00DDȘŌŤ]{2,})$/g, function (str, m1, m2) { return str.replace(m2, "_" + m2.toLowerCase()); })
            // Char group is caps & next isn't a letter e.g.: `URL_ToPath` -> `Url__ToPath`
            //                                                `MyURL_ToPath` -> `MyUrl_ToPath`
            .replace(/([A-Z\u00C0-\u00CF\u00D0-\u00D6\u00D8-\u00DDȘŌŤ]+)[^a-z\u00E0-\u00EF\u00F0-\u00F6\u00F8-\u00FDșōťA-Z\u00C0-\u00CF\u00D0-\u00D6\u00D8-\u00DDȘŌŤ]/g, function (str, m1) { return str.replace(m1, exports.capitalize(m1.toLowerCase()) + "_"); })
            // Char group is caps & next word starts w caps e.g. `MyURLToPath` -> `MyUrl_ToPath`
            .replace(/([A-Z\u00C0-\u00CF\u00D0-\u00D6\u00D8-\u00DDȘŌŤ]+)([A-Z\u00C0-\u00CF\u00D0-\u00D6\u00D8-\u00DDȘŌŤ])([a-z\u00E0-\u00EF\u00F0-\u00F6\u00F8-\u00FDșōť])/g, function (str, m1) { return str.replace(m1, exports.capitalize(m1.toLowerCase()) + "_"); })
            // 1st char group is caps & next isn't a letter e.g. `myURL_Test` -> `myUrl__Test`
            .replace(/([A-Z\u00C0-\u00CF\u00D0-\u00D6\u00D8-\u00DDȘŌŤ]{2,})([^a-z\u00E0-\u00EF\u00F0-\u00F6\u00F8-\u00FDșōťA-Z\u00C0-\u00CF\u00D0-\u00D6\u00D8-\u00DDȘŌŤ])/g, function (str, m1) { return str.replace(m1, exports.capitalize(m1.toLowerCase()) + "_"); })
            // Cap change after section of caps e.g. `getURLPath` -> `get_URL_Path`
            .replace(/([a-z\u00E0-\u00EF\u00F0-\u00F6\u00F8-\u00FDșōť])([A-Z\u00C0-\u00CF\u00D0-\u00D6\u00D8-\u00DDȘŌŤ]+)([A-Z\u00C0-\u00CF\u00D0-\u00D6\u00D8-\u00DDȘŌŤ])([^A-Z\u00C0-\u00CF\u00D0-\u00D6\u00D8-\u00DDȘŌŤ])/g, "$1_$2_$3$4")
            // Handle islands of caps e.g. `Some_TEST_String` -> `Some_test_String`
            .replace(/[^A-Z\u00C0-\u00CF\u00D0-\u00D6\u00D8-\u00DDȘŌŤa-z\u00E0-\u00EF\u00F0-\u00F6\u00F8-\u00FDșōť]([A-Z\u00C0-\u00CF\u00D0-\u00D6\u00D8-\u00DDȘŌŤ]+)[^A-Z\u00C0-\u00CF\u00D0-\u00D6\u00D8-\u00DDȘŌŤa-z\u00E0-\u00EF\u00F0-\u00F6\u00F8-\u00FDșōť]/g, function (str, m1) { return str.replace(m1, m1.toLowerCase()); })
            /*******************************************************************/
 ...
 */
exports.toDashCase = function (str) { return exports.toSnakeCase(str).replace(/_/g, "-"); };
/**
