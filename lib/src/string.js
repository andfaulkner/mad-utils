...
exports.toSnakeCase = function (str) {
    return str
        ...
        .replace(/[^A-Za-z]([A-Z]+)[^A-Za-z]/g, function (str, m1) { return str.replace(m1, m1.toLowerCase()); })
        /*******************************************************************/
 ...
 */
exports.toDashCase = function (str) { return str && exports.toSnakeCase(str).replace(/_/g, "-"); };
/**
