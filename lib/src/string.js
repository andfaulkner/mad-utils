 ...
 *         </body>
 */
function _detectShortestIndentInArray(lines, log) {
 ...
 */
function withLeftIndent(strings, leftPadSize, log) {
    ...
    var shortestIndent = _detectShortestIndentInArray(lines, log);
 ...
 */
function _validateWithLeftIndent(leftPadSize) {
