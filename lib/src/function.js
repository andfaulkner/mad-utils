...
var loop2 = function (func) { return [func(), func()]; };
/** Run given function 3X, returning results as an array containing all 3 return vals. */
var loop3 = function (func) { return [func(), func(), func()]; };
/** Run given function 4X, returning results as an array containing all 4 return vals. */
var loop4 = function (func) { return [func(), func(), func(), func()]; };
/** Run given function 5X, returning results as an array containing all 5 return vals. */
var loop5 = function (func) { return [func(), func(), func(), func(), func()]; };
/** Run given function 6X, returning results as an array containing all 6 return vals. */
var loop6 = function (func) { return [func(), func(), func(), func(), func(), func()]; };
/****************************************** CONDITIONALS ******************************************/
/**
...
function condSwitch(cond, val) {
    ...
    while (condValPairsAndOrDefVal.length > 1) {
        ...
        loop2(function () { return condValPairsAndOrDefVal.shift(); });
    }
