...
function withoutLast(arrOrStr) { return arrOrStr.slice(0, -1); }
function withoutLast2(arrOrStr) { return arrOrStr.slice(0, -2); }
// tslint:disable-next-line: no-magic-numbers
function withoutLast3(arrOrStr) { return arrOrStr.slice(0, -3); }
function withoutFirst(arrOrStr) { return arrOrStr.slice(1); }
function withoutFirst2(arrOrStr) { return arrOrStr.slice(2); }
function withoutFirst3(arrOrStr) { return arrOrStr.slice(3); }
/**
...
exports.isArray = types_iso_1.isArray;
