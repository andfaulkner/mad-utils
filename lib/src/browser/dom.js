 ...
 */
exports.getUserAgentString = function (mWindow) { return (mWindow || window).navigator.userAgent; };
/**
 ...
 */
exports.osNameSnakeCase = function () { return string_1.toSnakeCase(exports.osName()); };
/**
