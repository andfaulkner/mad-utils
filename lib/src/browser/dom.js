 ...
 */
exports.userAgentParsed = exports.userAgentParsed || parseUserAgent();
/**
 ...
 */
exports.osName = function () { return exports.userAgentParsed.os.name; };
/**
 * Get name of browser, e.g. "Chrome" or "Firefox"
 * @return {string} Name of browser
 */
exports.browserName = function () { return exports.userAgentParsed.browser.name; };
/**
 ...
 */
exports.browserEngineName = function () { return exports.userAgentParsed.engine.name; };
/**
 * Get machine's OS semver version number (as a string), e.g. "17.14.2"
 * @return {string} numeric OS version (in string form)
 */
exports.osVersion = function () { return exports.userAgentParsed.os.version; };
/**
 * Get browser version number (as a string), e.g. "51.0.3272.211"
 * @return {string} Browser version number string
 */
exports.browserVersion = function () { return exports.userAgentParsed.browser.version; };
/**
 ...
 */
exports.browserEngineVersion = function () { return exports.userAgentParsed.engine.version; };
