...
function handleValidationError(error, errDisplayCb) {
    if (errDisplayCb === void 0) { errDisplayCb = console.log; }
...
function isValidString(_a) {
    ...
    try {
        ...
        conditions.forEach(function (props) {
            var type = props.type, errMsg = props.errMsg;
            var matcher = (props.type !== 'match_confirmation') && props.matcher;
            /* MATCHERS */
            switch (type) {
                case "gt":
                case "min":
                case "min_length":
                    if (testStr.length >= matcher)
                        return;
                    break;
                case "lt":
                case "max":
 ...
 */
exports.isEmailPotentiallyValid = function (email) { return !!email.match(/^.+@.+\..+$/gi); };
exports.isEmailValidBasic = exports.isEmailPotentiallyValid;
/******************************************** HELPERS *********************************************/
/**
 ...
 */
var validPostalCode = function (str, threeCharAllowed) {
    if (threeCharAllowed === void 0) { threeCharAllowed = true; }
    return threeCharAllowed
