...
/******************************************** HELPERS *********************************************/
function noLowercase(str) { return !str.match(/[a-z]/); }
exports.noLowercase = noLowercase;
function noUppercase(str) { return !str.match(/[A-Z]/); }
exports.noUppercase = noUppercase;
function noNumber(str) { return !str.match(/[0-9]/); }
exports.noNumber = noNumber;
