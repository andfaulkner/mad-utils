...
exports.isVoidOrString = function (val) {
    return typeof val === 'undefined' || val === null || exports.isString(val);
};
/**
...
exports.isIntegerLike = function (val) {
    ...
    if (parseInt(vStr) === parseFloat(vStr))
        return true;
...
exports.isDateLike = function (val) {
    if (typeof val === 'undefined' || val === null || typeof val === 'boolean')
        return false;
...
exports.singleton = function (constructor) {
    ...
    try {
        ...
        if (env_var_helpers_1.isVerbose)
            console.log("mad-utils->@singleton :: Cannot modify class name");
    }
    return SingletonClass;
};
/**
