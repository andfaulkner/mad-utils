...
(function (StackUtils) {
    ...
    StackUtils.removeFromStack = removeFromStack;
    ...
    StackUtils.getFirstStackItem = getFirstStackItem;
    ...
    StackUtils.getSecondStackItem = getSecondStackItem;
    ...
    StackUtils.getThirdStackItem = getThirdStackItem;
})(StackUtils = exports.StackUtils || (exports.StackUtils = {}));
