...
function isLeapYear(year) {
    ...
    if (!types_iso_1.isInt(year) || yearClean instanceof Error) {
 ...
 */
function convertDayOfWeekNumToString(day, doAbbreviate) {
    if (doAbbreviate === void 0) { doAbbreviate = false; }
...
exports.now = function (timeFormat) {
    ...
    return moment_1.default().format(timeFormat);
};
