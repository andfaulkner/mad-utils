 ...
 */
exports.deletablePropConfig = function (value) { return ({
    enumerable: true,
    configurable: true,
    writable: true,
    value: value
 ...
 */
exports.defineProp = function (obj, keyName, val, mutable) {
    if (mutable === void 0) { mutable = 'immutable'; }
    // Which property config to return
    var propConfig;
    if (mutable === false || mutable === 'immutable') {
        propConfig = exports.immutablePropConfig(val);
    }
    else if (mutable === true || mutable === 'mutable') {
        propConfig = exports.mutablePropConfig(val);
    }
    else {
        propConfig = exports.deletablePropConfig(val);
    }
...
exports.defineImmutableProp = function (obj, keyName, propVal) {
    exports.defineProp(obj, keyName, propVal, false);
    return obj;
};
...
exports.defineMutableProp = function (obj, keyName, propVal) {
    exports.defineProp(obj, keyName, propVal, true);
    return obj;
};
