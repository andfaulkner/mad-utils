...
describe("locale sub-module", function () {
    ...
    it("has object commonLangsObj, where all values are strings (full language names)", function () {
        ...
        chai_1.expect(shared_1.locale.commonLangsObj[Object.keys(shared_1.locale.commonLangsObj)[0]]).to.be.a('string');
    });
    ...
    it("has object canadaLangsObj, where all values are strings (full language names)", function () {
        ...
        chai_1.expect(shared_1.locale.canadaLangAbbrevs[Object.keys(shared_1.locale.canadaLangAbbrevs)[0]]).to.be.a('string');
    });
