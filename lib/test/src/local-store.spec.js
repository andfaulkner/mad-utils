...
describe("local-store sub-module", function () {
    ...
    describe('function getFromStorage', function () {
        ...
        it("should retrieve value from object getFromStorage function is bound to if no store " +
            ...
            chai_1.expect(browser_1.getFromStorage.call(mockClassStore, 'classStoreKey1')).to.eql('classStoreKey1_val_mockClassStore');
        });
        it("should give precedence to value in given object (store) if key also exists in " +
            ...
            chai_1.expect(browser_1.localStorageUtils.getFromStorage.call(mockClassStore, 'key1', mockStore)).to.eql('key1_val_mockStore');
        });
        it("should give precedence to value in object to which function is bound if key also " +
            ...
            chai_1.expect(browser_1.localStorageUtils.getFromStorage.call(mockClassStore, 'key1')).to.eql('key1_val_mockClassStore');
        });
