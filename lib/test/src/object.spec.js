...
describe("object sub-module", function () {
    ...
    describe("get", function () {
        ...
        it("returns matching key in object, when given string propPath w/ dots", function () {
            chai_1.expect(shared_1.get('a', obj1)).to.eql('one');
            chai_1.expect(shared_1.get('a.b', obj2)).to.eql('innerLvl2');
            chai_1.expect(shared_1.get('a.b.c', obj3)).to.eql('innerLvl3');
        });
        ...
        it("returns undefined if key doesn't exist in object & no defVal given", function () {
            chai_1.expect(shared_1.get('b', obj1)).to.be.undefined;
            chai_1.expect(shared_1.get('a.b.d.h.j', obj1)).to.be.undefined;
            chai_1.expect(shared_1.get('a[j][z][gr]', obj2)).to.be.undefined;
        });
        it("returns undefined if object doesn't exist & no defVal given", function () {
            var obj;
            chai_1.expect(shared_1.get('a', obj)).to.be.undefined;
        });
        it("returns undefined if given object with path undefined or undefined", function () {
            chai_1.expect(shared_1.get('a', undefined)).to.be.undefined;
        });
        it("if given defaultValue, return it if key doesn't exist in object", function () {
            chai_1.expect(shared_1.get('b', obj1, 'DEFAULT')).to.eql('DEFAULT');
            chai_1.expect(shared_1.get('a.b.d.h.j', obj1, 'DEFAULT')).to.eql('DEFAULT');
            chai_1.expect(shared_1.get('a[j][z][gr]', obj2, 'DEFAULT')).to.eql('DEFAULT');
        });
        it("if given defaultValue, return it if object doesn't exist", function () {
            var obj;
            chai_1.expect(shared_1.get('b', obj, 'DEFAULT')).to.eql('DEFAULT');
        });
        it("handles null property by returning undefined or default value", function () {
            chai_1.expect(shared_1.get(null, obj1)).to.be.undefined;
            chai_1.expect(shared_1.get(null, obj1, 'DEF')).to.eql('DEF');
        });
        it("handles undefined property by returning undefined or default value", function () {
            chai_1.expect(shared_1.get(undefined, obj1)).to.be.undefined;
            chai_1.expect(shared_1.get(undefined, obj1, 'DEF')).to.eql('DEF');
        });
