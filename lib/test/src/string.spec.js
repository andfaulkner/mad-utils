...
describe("string sub-module", function () {
    ...
    describe("withLeftIndent -- special string template type", function () {
        it("indents single-line string the given number of spaces", function () {
            chai_1.expect(withLeftIndent(templateObject_11 || (templateObject_11 = __makeTemplateObject(["", "asdf"], ["", "asdf"])), 4)).to.equal('    asdf');
            chai_1.expect(withLeftIndent(templateObject_12 || (templateObject_12 = __makeTemplateObject(["", "asdf"], ["", "asdf"])), 1)).to.equal(' asdf');
        });
        it("can indent 0 spaces", function () {
            chai_1.expect(withLeftIndent(templateObject_13 || (templateObject_13 = __makeTemplateObject(["", "asdf"], ["", "asdf"])), 0)).to.equal('asdf');
        });
        ...
        it("Removes preceding whitespace that exists on every line, & adds no indent if indent val is 0", function () {
            chai_1.expect(withLeftIndent(templateObject_15 || (templateObject_15 = __makeTemplateObject(["", "\n                First line\n                Second line"], ["", "\n                First line\n                Second line"])), 0)).to.eql('First line\nSecond line');
        });
        it("Defaults to indent 0", function () {
            chai_1.expect(withLeftIndent(templateObject_16 || (templateObject_16 = __makeTemplateObject(["\n                First line\n                Second line"], ["\n                First line\n                Second line"])))).to.eql('First line\nSecond line');
        });
    });
...
function defMultilineWithLeftIndentStr1() {
    return withLeftIndent(templateObject_17 || (templateObject_17 = __makeTemplateObject(["", "\nasdf\nasdf"], ["", "\nasdf\nasdf"])), 4);
}
function defMultilineWithLeftIndentStr2() {
    return withLeftIndent(templateObject_18 || (templateObject_18 = __makeTemplateObject(["", "\nasdf\n\nasdf"], ["", "\nasdf\n\nasdf"])), 8);
}
