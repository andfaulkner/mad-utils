...
describe("string sub-module", function () {
    ...
    describe("withLeftIndent -- special string template type", function () {
        it("indents single-line string the given number of spaces", function () {
            chai_1.expect(withLeftIndent(templateObject_1 || (templateObject_1 = __makeTemplateObject(["", "asdf"], ["", "asdf"])), 4)).to.equal('    asdf');
            chai_1.expect(withLeftIndent(templateObject_2 || (templateObject_2 = __makeTemplateObject(["", "asdf"], ["", "asdf"])), 1)).to.equal(' asdf');
        });
        it("can indent 0 spaces", function () {
            chai_1.expect(withLeftIndent(templateObject_3 || (templateObject_3 = __makeTemplateObject(["", "asdf"], ["", "asdf"])), 0)).to.equal('asdf');
        });
        ...
        it("Removes preceding whitespace that exists on every line, replaces with given indent val", function () {
            chai_1.expect(withLeftIndent(templateObject_4 || (templateObject_4 = __makeTemplateObject(["", "\n                First line\n                Second line"], ["", "\n                First line\n                Second line"])), 4)).to.eql('    First line\n    Second line');
        });
        it("Removes preceding whitespace that exists on every line, & adds no indent if indent val is 0", function () {
            chai_1.expect(withLeftIndent(templateObject_5 || (templateObject_5 = __makeTemplateObject(["", "\n                First line\n                Second line"], ["", "\n                First line\n                Second line"])), 0)).to.eql('First line\nSecond line');
        });
        it("Defaults to indent 0", function () {
            chai_1.expect(withLeftIndent(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n                First line\n                Second line"], ["\n                First line\n                Second line"])))).to.eql('First line\nSecond line');
        });
    });
...
function defMultilineWithLeftIndentStr1() {
    return withLeftIndent(templateObject_7 || (templateObject_7 = __makeTemplateObject(["", "\nasdf\nasdf"], ["", "\nasdf\nasdf"])), 4);
}
function defMultilineWithLeftIndentStr2() {
    return withLeftIndent(templateObject_8 || (templateObject_8 = __makeTemplateObject(["", "\nasdf\n\nasdf"], ["", "\nasdf\n\nasdf"])), 8);
}
