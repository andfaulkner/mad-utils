...
describe("string sub-module", function () {
    ...
    describe("deindent -- special string template type", function () {
        ...
        it("Reduces indent down to the level of the smallest-indented row", function () {
            var outStr = deindent(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n                Hello,\n                    Is it biscotti I'm looking for?\n                        Hello?\n                Sincerely, The Cookie Monster\n            "], ["\n                Hello,\n                    Is it biscotti I'm looking for?\n                        Hello?\n                Sincerely, The Cookie Monster\n            "])));
    ...
    describe("withLeftIndent -- special string template type", function () {
        it("indents single-line string the given number of spaces", function () {
            chai_1.expect(withLeftIndent(templateObject_9 || (templateObject_9 = __makeTemplateObject(["", "asdf"], ["", "asdf"])), 4)).to.equal('    asdf');
            chai_1.expect(withLeftIndent(templateObject_10 || (templateObject_10 = __makeTemplateObject(["", "asdf"], ["", "asdf"])), 1)).to.equal(' asdf');
        });
        it("can indent 0 spaces", function () {
            chai_1.expect(withLeftIndent(templateObject_11 || (templateObject_11 = __makeTemplateObject(["", "asdf"], ["", "asdf"])), 0)).to.equal('asdf');
        });
        ...
        it("Removes preceding whitespace that exists on every line, replaces with given indent val", function () {
            chai_1.expect(withLeftIndent(templateObject_12 || (templateObject_12 = __makeTemplateObject(["", "\n                First line\n                Second line"], ["", "\n                First line\n                Second line"])), 4)).to.eql('    First line\n    Second line');
        });
        it("Removes preceding whitespace that exists on every line, & adds no indent if indent val is 0", function () {
            chai_1.expect(withLeftIndent(templateObject_13 || (templateObject_13 = __makeTemplateObject(["", "\n                First line\n                Second line"], ["", "\n                First line\n                Second line"])), 0)).to.eql('First line\nSecond line');
        });
        it("Defaults to indent 0", function () {
            chai_1.expect(withLeftIndent(templateObject_14 || (templateObject_14 = __makeTemplateObject(["\n                First line\n                Second line"], ["\n                First line\n                Second line"])))).to.eql('First line\nSecond line');
        });
    });
...
function defMultilineWithLeftIndentStr1() {
    return withLeftIndent(templateObject_15 || (templateObject_15 = __makeTemplateObject(["", "\nasdf\nasdf"], ["", "\nasdf\nasdf"])), 4);
}
function defMultilineWithLeftIndentStr2() {
    return withLeftIndent(templateObject_16 || (templateObject_16 = __makeTemplateObject(["", "\nasdf\n\nasdf"], ["", "\nasdf\n\nasdf"])), 8);
}
