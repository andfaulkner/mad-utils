    ...
    describe("types-iso sub-module", function () {
        ...
        describe("isString function", function () {
            ...
            it("returns true if given a String-inheriting object instance", function () {
                ...
                console.log(shared_1.isString(new PrefixedString()));
                console.log("is new PrefixedString() a string? Manual test:");
                console.log(typeof (new PrefixedString()) === 'string' ||
        ...
        describe("isFunction function", function () {
            ...
            it("returns true if given a classic ES5 (and under) lambda function", function () {
                chai_1.expect(shared_1.types.isFunction(function () { return 'ok'; })).to.be.true;
                chai_1.expect(shared_1.types.isFunction(function () { return false; })).to.be.true;
            ...
            it("returns true if given a named classic ES5 (and under) function", function () {
                chai_1.expect(shared_1.types.isFunction(function testFunc1() { return 'ok'; })).to.be.true;
                chai_1.expect(shared_1.types.isFunction(function testFunc2() { return false; })).to.be.true;
                ...
                chai_1.expect(shared_1.types.isFunction(function testFunc5(arg1, arg2) { return arg1 + arg2; })).to.be.true;
            });
            ...
            it("returns true if given a function with an object merged in", function () {
                chai_1.expect(shared_1.types.isFunction(Object.assign(function testFunc() { return 'result'; }, { a: 1, b: 2 }))).to.be.true;
            });
        });
