...
describe("types sub-modules", function () {
    describe("types-iso sub-module", function () {
        ...
        describe("isUndefined function", function () {
            it("returns false given null", function () {
                chai_1.expect(shared_1.types.isUndefined(null)).to.equal(false);
            });
            it("returns true given undefined", function () {
                chai_1.expect(shared_1.types.isUndefined(undefined)).to.equal(true);
                chai_1.expect(shared_1.types.isUndefined()).to.equal(true);
            });
            it("returns false given falsy values besides undefined", function () {
                chai_1.expect(shared_1.types.isUndefined(0)).to.equal(false);
                chai_1.expect(shared_1.types.isUndefined("")).to.equal(false);
                chai_1.expect(shared_1.types.isUndefined(NaN)).to.equal(false);
                chai_1.expect(shared_1.types.isUndefined(false)).to.equal(false);
            });
            it("returns false given any \"truthy\" value", function () {
                chai_1.expect(shared_1.types.isUndefined("undefined")).to.equal(false);
                chai_1.expect(shared_1.types.isUndefined("null")).to.equal(false);
                chai_1.expect(shared_1.types.isUndefined(1)).to.equal(false);
                chai_1.expect(shared_1.types.isUndefined("OK")).to.equal(false);
                chai_1.expect(shared_1.types.isUndefined(Infinity)).to.equal(false);
                chai_1.expect(shared_1.types.isUndefined(-1)).to.equal(false);
                chai_1.expect(shared_1.types.isUndefined({})).to.equal(false);
                chai_1.expect(shared_1.types.isUndefined([])).to.equal(false);
                chai_1.expect(shared_1.types.isUndefined([null, undefined])).to.equal(false);
                chai_1.expect(shared_1.types.isUndefined({ 'null': null })).to.equal(false);
                chai_1.expect(shared_1.types.isUndefined(Object)).to.equal(false);
                chai_1.expect(shared_1.types.isUndefined(Object.prototype)).to.equal(false);
                chai_1.expect(shared_1.types.isUndefined(0.00001)).to.equal(false);
                chai_1.expect(shared_1.types.isUndefined(function () { return null; })).to.equal(false);
                chai_1.expect(shared_1.types.isUndefined(function () { return undefined; })).to.equal(false);
                chai_1.expect(shared_1.types.isUndefined(/** @class */ (function () {
                    function TestClass() {
                    }
                    return TestClass;
                }()))).to.equal(false);
                chai_1.expect(shared_1.types.isUndefined(Symbol())).to.equal(false);
                chai_1.expect(shared_1.types.isUndefined(Symbol('null'))).to.equal(false);
            });
        });
        describe("isNullOrUndefined function", function () {
            it("returns true given null", function () {
                chai_1.expect(shared_1.types.isNullOrUndefined(null)).to.equal(true);
            });
            it("returns true given undefined", function () {
                chai_1.expect(shared_1.types.isNullOrUndefined(undefined)).to.equal(true);
                chai_1.expect(shared_1.types.isNullOrUndefined()).to.equal(true);
            });
            it("returns false given falsy values besides null and undefined", function () {
                chai_1.expect(shared_1.types.isNullOrUndefined(0)).to.equal(false);
                chai_1.expect(shared_1.types.isNullOrUndefined("")).to.equal(false);
                chai_1.expect(shared_1.types.isNullOrUndefined(NaN)).to.equal(false);
                chai_1.expect(shared_1.types.isNullOrUndefined(false)).to.equal(false);
            });
            it("returns false given any value besides null & undefined", function () {
                chai_1.expect(shared_1.types.isNullOrUndefined(1)).to.equal(false);
                chai_1.expect(shared_1.types.isNullOrUndefined("OK")).to.equal(false);
                chai_1.expect(shared_1.types.isNullOrUndefined(Infinity)).to.equal(false);
                chai_1.expect(shared_1.types.isNullOrUndefined(-1)).to.equal(false);
                chai_1.expect(shared_1.types.isNullOrUndefined({})).to.equal(false);
                chai_1.expect(shared_1.types.isNullOrUndefined([])).to.equal(false);
                chai_1.expect(shared_1.types.isNullOrUndefined([null, undefined])).to.equal(false);
                chai_1.expect(shared_1.types.isNullOrUndefined({ 'null': null })).to.equal(false);
                chai_1.expect(shared_1.types.isNullOrUndefined(Object)).to.equal(false);
                chai_1.expect(shared_1.types.isNullOrUndefined(Object.prototype)).to.equal(false);
                chai_1.expect(shared_1.types.isNullOrUndefined(0.00001)).to.equal(false);
                chai_1.expect(shared_1.types.isNullOrUndefined(function () { return null; })).to.equal(false);
                chai_1.expect(shared_1.types.isNullOrUndefined(function () { return undefined; })).to.equal(false);
                chai_1.expect(shared_1.types.isNullOrUndefined(/** @class */ (function () {
                    function TestClass() {
                    }
                    return TestClass;
                }()))).to.equal(false);
                chai_1.expect(shared_1.types.isNullOrUndefined(Symbol())).to.equal(false);
                chai_1.expect(shared_1.types.isNullOrUndefined(Symbol('null'))).to.equal(false);
            });
        });
    ...
    describe("isAlphabeticChar", function () {
        ...
        it("By default returns true given accented characters / diacritics", function () {
            chai_1.expect(shared_1.types.isAlphabeticChar("\u00E0")).to.eql(true);
            chai_1.expect(shared_1.types.isAlphabeticChar("\u00E7")).to.eql(true);
            chai_1.expect(shared_1.types.isAlphabeticChar("\u00EB")).to.eql(true);
            chai_1.expect(shared_1.types.isAlphabeticChar("\u0127")).to.eql(true);
            chai_1.expect(shared_1.types.isAlphabeticChar("\u00CF")).to.eql(true);
            chai_1.expect(shared_1.types.isAlphabeticChar("\u00DB")).to.eql(true);
            chai_1.expect(shared_1.types.isAlphabeticChar("\u017D")).to.eql(true);
        });
        it("If 2nd arg is false, returns false given accented characters / diacritics", function () {
            chai_1.expect(shared_1.types.isAlphabeticChar("\u00E0", false)).to.eql(false);
            chai_1.expect(shared_1.types.isAlphabeticChar("\u00E7", false)).to.eql(false);
            chai_1.expect(shared_1.types.isAlphabeticChar("\u00EB", false)).to.eql(false);
            chai_1.expect(shared_1.types.isAlphabeticChar("\u0127", false)).to.eql(false);
            chai_1.expect(shared_1.types.isAlphabeticChar("\u00CF", false)).to.eql(false);
            chai_1.expect(shared_1.types.isAlphabeticChar("\u00DB", false)).to.eql(false);
            chai_1.expect(shared_1.types.isAlphabeticChar("\u017D", false)).to.eql(false);
        });
    });
