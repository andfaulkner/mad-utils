...
var nonIntNums = [10.2, 0.919232, 0.000000001, -0.001, 383.234345, -123124.2342, 10.00000000001];
/********************************************* TESTS **********************************************/
describe("types sub-modules", function () {
    describe("types-iso sub-module", function () {
        ...
        describe("isInteger function (and alias isInt)", function () {
            ...
            numberDetectorFunctionTests('isInteger', shared_1.types.isInteger);
 ...
 */
function numberDetectorFunctionTests(fnName, testFunc) {
