...
describe.only("date sub-module", function () {
    ...
    describe("dateStringWithMonthTextToMoment function", function () {
        ...
        it("returns null with invalid inputs", function () {
            ...
            chai_1.expect(shared_1.dateStringWithMonthTextToMoment("10102019")).to.be.null;
            chai_1.expect(shared_1.dateStringWithMonthTextToMoment("Jan 33, 2020")).to.be.null;
        });
