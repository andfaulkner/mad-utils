...
describe.only("date sub-module", function () {
    ...
    describe("dateStringWithMonthTextToMoment function", function () {
        ...
        it("Handles a variety of inputs", function () {
            ...
            var dateStr17 = shared_1.dateStringWithMonthTextToMoment("2018, 31 Dec");
            ...
            chai_1.expect(dateStr17.isValid()).to.be.true;
            // Reset to inital locale
            moment.locale(origLocale);
        });
        it("returns null with invalid inputs", function () {
            console.log("\n\nStarting testStrInvalid1 test...");
            var testStrInvalid1 = shared_1.dateStringWithMonthTextToMoment(null);
            console.log("testStrInvalid1:", testStrInvalid1);
            console.log("\n\nStarting testStrInvalid2 test...");
            var testStrInvalid2 = shared_1.dateStringWithMonthTextToMoment("");
            console.log("testStrInvalid2:", testStrInvalid2);
            console.log("\n\nStarting testStrInvalid3 test...");
            var testStrInvalid3 = shared_1.dateStringWithMonthTextToMoment("10-10-2019");
            console.log("testStrInvalid3:", testStrInvalid3);
            console.log("\n\nStarting testStrInvalid4 test...");
            var testStrInvalid4 = shared_1.dateStringWithMonthTextToMoment("10102019");
            console.log("testStrInvalid4:", testStrInvalid4);
            console.log("\n\nStarting testStrInvalid5 test...");
            var testStrInvalid5 = shared_1.dateStringWithMonthTextToMoment("Jan 33, 2020");
            console.log("testStrInvalid5:", testStrInvalid5);
            chai_1.expect(testStrInvalid1).to.be.null;
            chai_1.expect(testStrInvalid2).to.be.null;
            chai_1.expect(testStrInvalid3).to.be.null;
            chai_1.expect(testStrInvalid4).to.be.null;
            chai_1.expect(testStrInvalid5).to.be.null;
        });
        it("handles moment-friendly strings with a fallback", function () {
            var fallbackStr1 = shared_1.dateStringWithMonthTextToMoment("2017-10-19");
            console.log("fallbackStr1:", fallbackStr1);
            chai_1.expect(fallbackStr1.isValid()).to.be.true;
            var fallbackStr2 = shared_1.dateStringWithMonthTextToMoment("19-10-2017", { fallbackFormat: 'DD-MM-YYYY' });
            console.log("fallbackStr2:", fallbackStr2);
            chai_1.expect(fallbackStr2.isValid()).to.be.true;
        });
    });
});
