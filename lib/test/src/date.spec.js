...
describe.only("date sub-module", function () {
    ...
    describe("dateStringWithMonthTextToMoment function", function () {
        ...
        it("returns null when given 2-part date strings", function () {
            chai_1.expect(shared_1.dateStringWithMonthTextToMoment("2017-10")).to.be.null;
            chai_1.expect(shared_1.dateStringWithMonthTextToMoment("10-1900")).to.be.null;
            chai_1.expect(shared_1.dateStringWithMonthTextToMoment("1-1900")).to.be.null;
        });
        it("returns null when given invalid strings with dashes", function () {
            chai_1.expect(shared_1.dateStringWithMonthTextToMoment("Non-sp\u00E9cifi\u00E9")).to.be.null;
            chai_1.expect(shared_1.dateStringWithMonthTextToMoment("non-valid")).to.be.null;
        });
        it("returns null when given phrases with spaces", function () {
            chai_1.expect(shared_1.dateStringWithMonthTextToMoment("This is not valid")).to.be.null;
            chai_1.expect(shared_1.dateStringWithMonthTextToMoment("This is not valid")).to.be.null;
        });
