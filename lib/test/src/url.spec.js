...
describe("url sub-module", function () {
    ...
    describe("extractURLPathnameWithQuery", function () {
        it("should return pathname from given URL with protocol and no query", function () {
            chai_1.expect(shared_1.extractURLPathnameWithQuery("https://www.example.com/a/b/c")).to.eql("/a/b/c");
            chai_1.expect(shared_1.extractURLPathnameWithQuery("https://example.com/asdf")).to.eql("/asdf");
        });
        it("should return pathname from given URL with no protocol and no query", function () {
            chai_1.expect(shared_1.extractURLPathnameWithQuery("www.example.com/a/b/c")).to.eql("/a/b/c");
            chai_1.expect(shared_1.extractURLPathnameWithQuery("example.com/asdf")).to.eql("/asdf");
        });
        it("should return pathname & query from given URL with no protocol", function () {
            chai_1.expect(shared_1.extractURLPathnameWithQuery("www.example.com/a/b/c?k=v")).to.eql("/a/b/c?k=v");
            chai_1.expect(shared_1.extractURLPathnameWithQuery("example.com/asdf?key=val&key2=val2")).to.eql("/asdf?key=val&key2=val2");
        });
        it("should return pathname & query from given URL with protocol", function () {
            chai_1.expect(shared_1.extractURLPathnameWithQuery("https://www.example.com/a/b/c?k=v")).to.eql("/a/b/c?k=v");
            chai_1.expect(shared_1.extractURLPathnameWithQuery("https://example.com/asdf?key=val&key2=val2")).to.eql("/asdf?key=val&key2=val2");
        });
    });
});
