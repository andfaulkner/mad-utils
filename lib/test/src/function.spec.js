...
describe("function sub-module", function () {
    ...
    describe("throttle", function () {
        ...
        it("requires the correct arguments for the created 'throttled' function", function () {
            var arr = [];
            var throttledFn = shared_1.throttle(function (str) { return arr.push(str); }, 200, true);
            throttledFn('First');
            setTimeout(function () { return throttledFn('Second'); }, 300);
            throttledFn("WON'T BE INCLUDED");
            throttledFn("ALSO WON'T BE INCLUDED");
            setTimeout(function () { return chai_1.expect(arr).to.eql(['First', 'Second']); }, 500);
        });
    });
