...
exports.parseQueryParams = (queryParamsString = window.location.search) => {
    return queryParamsString.replace(/^\?/, '').split('&').reduce((acc, pair) => Object.assign(acc, { [pair.split('=')[0]]: pair.split('=')[1] }), {});
};
/********************************************* TYPES **********************************************/
/**
...
const coll = {
    last: exports.last, last2: exports.last2, last3: exports.last3,
    firstN, lastN: exports.lastN, arrayN: exports.arrayN,
...
exports.mUtils = {
    array: {
        ...
        third: exports.third,
        first2: exports.first2,
        first3: exports.first3,
        last: exports.last,
