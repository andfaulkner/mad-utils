...
var array_collection_1 = require("./src/array-collection");
var collection = require("./src/array-collection");
...
exports.stringToEnumVal = function (val, Enum) {
    ...
    var cleanStack = scrubStackTrace(stack, 'stringToEnumVal');
...
var coll = {
    ...
    secondLast: array_collection_1.secondLast, thirdLast: array_collection_1.thirdLast, isArray: isArray,
    get: array_collection_1.get,
};
var str = {
    cap1LowerRest: cap1LowerRest,
...
exports.mUtils = {
    ...
    dom: dom,
    enum: {
        enumToStringArray: enumToStringArray,
    ...
    error: {
        DecoratorError: exports.DecoratorError,
        scrubStackTrace: scrubStackTrace,
    },
    event: event,
    isNode: isNode,
    json: {
    ...
    object: {
        ...
        get: array_collection_1.get,
        assignFrozenClone: array_collection_1.assignFrozenClone,
    },
    query: {
