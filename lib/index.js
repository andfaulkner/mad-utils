...
exports.logMarkers = logMarkers;
const { buildFileTagString } = require('./src/build-file-tag-string');
exports.buildFileTagString = buildFileTagString;
exports.buildFileTag = buildFileTagString;
exports.buildTagString = buildFileTagString;
exports.buildTag = buildFileTagString;
exports.makeFileTagString = buildFileTagString;
exports.makeFileTag = buildFileTagString;
exports.makeTagString = buildFileTagString;
exports.makeTag = buildFileTagString;
const colors = (isNode)
    ? require('colors/safe')
    : {};
/*************************************** LOG LEVEL HANDLING ***************************************/
