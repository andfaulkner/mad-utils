...
const validateBuildFileTagStringInput = (filename: any, colourizer: any, rpadSize: any): void => {
 ...
 */
export const buildFileTagString = (filename: string, colourizer?: Function, rpadSize = 20): string => {
