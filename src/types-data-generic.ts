...
export const biologicalSexesWithBoth = deepFreeze(
    Object.assign({}, biologicalSexes, {
        both: 'both' as 'both',
    })
);
...
export const biologicalSexesWithOther = deepFreeze(
    Object.assign({}, biologicalSexes, {
 ...
 */
export const genderFull = deepFreeze(
    Object.assign({}, biologicalSexesWithOther, {
